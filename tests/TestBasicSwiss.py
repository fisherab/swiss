...
##        sw.addPlayer("Q");
        ...
        print("KO Rounds " + str(sw.getKORounds()))
        print("Max rounds " + str(sw.getMaxRounds()))
        print("Rec rounds " + str(sw.getRecRounds()))

        for j in range(sw.getRecRounds()+2):
            if j != 0:
                sw.computeRanking()
                print("Ranking after round " + str(j) + " ");
                for name in sw.ranking:
                    print(name + ": " + str(sw.players[name].games) + "  ", end ='');
                print()
                sw.prepareRound()
            ...
            print("Score in round ", j + 1,":", round);
